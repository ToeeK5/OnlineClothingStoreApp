...
class CheckoutActivity : AppCompatActivity() {
    ...
    private fun updateOrderSummary() {
        ...
        if (paymentMethod == PAYMENT_QR) {
            binding.layoutQrDiscount.visibility = View.VISIBLE
            binding.txtCheckoutDiscount.text = "-${formatMoney(discount)}"

            binding.txtCheckoutOriginalTotal.visibility = View.VISIBLE
            ...
            binding.layoutQrDiscount.visibility = View.GONE

            binding.txtCheckoutOriginalTotal.visibility = View.GONE
            binding.txtCheckoutOriginalTotal.paintFlags =
