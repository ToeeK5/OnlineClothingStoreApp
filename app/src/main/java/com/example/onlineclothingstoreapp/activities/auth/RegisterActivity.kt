...
import com.example.onlineclothingstoreapp.models.auth.User
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun showSnackbar(message: String, isSuccess: Boolean = false) {
        ...
        if (isSuccess) {
            snackbar.setBackgroundTint(resources.getColor(R.color.holo_green_dark, null))
        } else {
            snackbar.setBackgroundTint(resources.getColor(R.color.holo_red_dark, null))
        }
        snackbar.show()
    }
}